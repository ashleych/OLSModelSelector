...
dr_logit_test_assertions <- function(excelDetails, sensitivity_tests = TRUE, base_variable = "DR") {
...
test_that("LOgit FD Testing sensitivity with transformations", {
...
test_that("Logit FD Testing the scenarios", {
  ...
  scen2_preds <- excelDetails_1$scenario_list[[2]]@predictions
  print(scen2_preds$predicted_values_transformed[index_of_predictions] > baseline_preds$predicted_values_transformed[index_of_predictions])
  is_intuitive <- sum(scen2_preds$predicted_values_transformed[index_of_predictions] > baseline_preds$predicted_values_transformed[index_of_predictions]) / length(index_of_predictions)
  print(is_intuitive)
